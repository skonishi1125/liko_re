    ...
    <body>
        ...
        <?php endif; ?>
            ...
            <?php foreach ($posts as $post): ?>
                <div class="col-md-12 post-wrapper">
                    ...
                    <?php endif; ?>
                        ...
                        <?php else: ?>
                            <a class="preGood" href="userpage.php?good=<?php echo h($post['id']); ?>">
            ...
            <div class="page-wrapper col-md-12">
                <?php if($page > 1): ?>
                    <a href="userpage.php?page=<?php print($page - 1); ?>">前のページへ</a>
                <?php else: ?>
                    <span>前のページへ</span> | 
                <?php endif; ?>

                <?php if($page < $maxPage): ?>
                    <a href="userpage.php?page=<?php print($page + 1); ?>">次のページへ</a>
                <?php else: ?>
                    <span>次のページへ</span>
                <?php endif; ?>
