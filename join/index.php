...
<div class="container">
  ...
  <div class="qaTitle-wrapper col-md-12" id="accordion_menu" data-toggle="collapse" href="#menu01" aria-controls="#menu01" aria-expanded="false">
    <h4>このサイトについて</h4>
  </div>

  <div class="qaAnswer-wrapper collapse col-md-12" id="menu01" data-parent="#accordion_menu">
    <p>ポートフォリオ用のSNSサイトとなります。</p>
    <p>突然メンテナンスを行ったり、サービスが停止することがございます。ご了承ください。</p>
  </div>

  <div class="qaTitle-wrapper col-md-12" id="accordion_menu" data-toggle="collapse" href="#menu02" aria-controls="#menu02" aria-expanded="false">
    <h4>情報の取扱いについて</h4>
  </div>

  <div class="qaAnswer-wrapper collapse col-md-12" id="menu02" data-parent="#accordion_menu">
    <p>
  ...
  <div class="qaTitle-wrapper col-md-12" id="accordion_menu" data-toggle="collapse" href="#menu03" aria-controls="#menu03" aria-expanded="false">
    <h4>バグやエラーが発生した場合</h4>
  </div>

  <div class="qaAnswer-wrapper collapse col-md-12" id="menu03" data-parent="#accordion_menu">
